...
namespace BetterAPI.Guidelines
{
    ...
    {
        public static IHostBuilder HostApiServer<TStartup>(this IHostBuilder builder, Func<IConfiguration, IConfiguration>? configSelector = default) where TStartup : class
        {
            ...
            builder.ConfigureWebHostDefaults(configure =>
            {
                ...
                configure.ConfigureServices((context, services) =>
                {
                    ...
                    var accessor = CallAccessor.Create(typeof(TStartup).GetMethod(nameof(IStartup.ConfigureServices)) ?? throw new InvalidOperationException());
                ...
                configure.Configure((context, app) =>
                {
                    ...
                    var accessor = CallAccessor.Create(typeof(TStartup).GetMethod(nameof(IStartup.Configure)) ?? throw new InvalidOperationException());
