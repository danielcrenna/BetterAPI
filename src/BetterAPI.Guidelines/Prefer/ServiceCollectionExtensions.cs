...
namespace BetterAPI.Guidelines.Prefer
{
    public static class ServiceCollectionExtensions
    {
        ...
        /// By default, the full representation is returned.
        /// </summary>
        public static IServiceCollection AddPrefer(this IServiceCollection services, Action<PreferOptions>? configureAction = null)
        {
            ...
            services.AddMvc(o =>
            {
                o.Filters.AddService<PreferActionFilter>(int.MaxValue);
            });
            return services;
        }
    }
