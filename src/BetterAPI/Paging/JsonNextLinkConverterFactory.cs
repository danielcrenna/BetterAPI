...
namespace BetterAPI.Paging
{
    ...
    /// </summary>
    public sealed class JsonNextLinkConverterFactory : JsonConverterFactory
    {
        public override bool CanConvert(Type typeToConvert)
        {
            ...
            var annotated = typeToConvert.ImplementsGeneric(typeof(NextLinkAnnotated<>));
            return annotated;
        }
        ...
        public override JsonConverter CreateConverter(Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            var converterType = typeof(JsonNextLinkConverter<>).MakeGenericType(underlyingType) ?? throw new NullReferenceException();
