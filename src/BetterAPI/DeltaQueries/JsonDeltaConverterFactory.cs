...
namespace BetterAPI.DeltaQueries
{
    ...
    /// </summary>
    public sealed class JsonDeltaConverterFactory : JsonConverterFactory
    {
        public override bool CanConvert(Type typeToConvert)
        {
            ...
            var annotated = typeToConvert.ImplementsGeneric(typeof(DeltaAnnotated<>));
            return annotated;
        }
        ...
        public override JsonConverter? CreateConverter(Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            var converterType = typeof(JsonDeltaConverter<>).MakeGenericType(underlyingType) ?? throw new NullReferenceException();
